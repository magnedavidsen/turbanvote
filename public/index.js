...
var _magnedavidsen$hmm$Main$counterEndpoint = 'ws://turbanvote.herokuapp.com/counter';
...
var _magnedavidsen$hmm$Main$save = _elm_lang$core$Native_Platform.outgoingPort(
	'save',
	function (v) {
		return v;
	});
var _magnedavidsen$hmm$Main$load = _elm_lang$core$Native_Platform.incomingPort(
	'load',
...
var _magnedavidsen$hmm$Main$doload = _elm_lang$core$Native_Platform.outgoingPort(
	'doload',
	function (v) {
		return null;
	});
...
var _magnedavidsen$hmm$Main$Doload = {ctor: 'Doload'};
var _magnedavidsen$hmm$Main$ReceiveTurbans = function (a) {
	return {ctor: 'ReceiveTurbans', _0: a};
};
var _magnedavidsen$hmm$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$websocket$WebSocket$listen, _magnedavidsen$hmm$Main$counterEndpoint, _magnedavidsen$hmm$Main$ReceiveTurbans),
			_1: {
				ctor: '::',
				_0: _magnedavidsen$hmm$Main$load(_magnedavidsen$hmm$Main$Load),
				_1: {ctor: '[]'}
			}
		});
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _magnedavidsen$hmm$Main$main !== 'undefined') {
    _magnedavidsen$hmm$Main$main(Elm['Main'], 'Main', undefined);
}
